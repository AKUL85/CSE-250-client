...
const DashboardPage = () => {
  ...
  const kpis =
    user.role === "student"
      ? mockDashboardKPIs.student
      : mockDashboardKPIs.admin;
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-zinc-500">
                      {dayjs(kpis.nextLaundrySlot).format("h:mm A")} - Machine
                      M001
                    </p>
                  </div>
  ...
  // Admin Dashboard
    ...
    return (
      ...
      >
        {/* Welcome Section */}
        <motion.div variants={itemVariants}>
          <div className="rounded-2xl p-8 text-white shadow-lg bg-gradient-to-br from-blue-400 to-indigo-400">
            {" "}
            ...
            <Card className="p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <NavLink to="/admin/seat-applications">
                    Seat Applications
                  </NavLink>
